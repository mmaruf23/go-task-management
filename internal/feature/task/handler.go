...
func (h *TaskHandler) Update(c *gin.Context) {
	...
	task, err := h.service.Update(c.Request.Context(), userID, taskID, req)
	if err != nil {
		response.Error(c, http.StatusInternalServerError, "FAILED_UPDATE_TASK", nil)
		return
	}

	response.Success(c, http.StatusOK, "SUCCESS_UPDATE_TASK", task)
}
